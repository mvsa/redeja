 ...
 <div class="page-content">
    ...
    <form method ="POST" action="../../controllers/3etapasController.php">
              ...
              <div class="mdl-card__supporting-text">
                   <div id="firstPage">
                    ...
                    <br>
                      ...
                      <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        ...
                        <label class="mdl-textfield__label" for="titulo">Avaliação da leitura</label>
                        <br>
                   ...
                   <?php for ($j=11;$j<=15;$j++){  ?>
                     <br>
                       <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect">
                          <input required type="radio" name="answer" value="<?php echo $j-10; ?>" class="mdl-radio__button"></input>
                  ...
                  <input  class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" value="Enviar" type="submit" name="third"  class="btn btn-info btn-fill ">
